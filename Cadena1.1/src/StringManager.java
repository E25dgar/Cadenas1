...
public class StringManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEn.setBackground(new java.awt.Color(0, 51, 255));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnShow, javax.swing.GroupLayout.DEFAULT_SIZE, 413, Short.MAX_VALUE)
    ...
    System.out.println("your name in May:"+yName);
    lblNameMa.setText(txtName.getText().toUpperCase());
    
    
    System.out.println("your name in Min:"+yName);
    lblNameMin.setText(txtName.getText().toLowerCase());
    
    System.out.println("total character:"+yName);
    lblchara.setText(String.valueOf(c));
    
    System.out.println("Initial capital letters:"+yName);
    
    
     char primero=yName.charAt(0);   
     char ant=0;
     
     
     if(yName.length()>0){
     
      yName=Character.toUpperCase(primero)+yName.substring(1, yName.length());
        lblletters.setText(yName);
    }else if (yName.length()==0 || ant==32){
        
        yName=Character.toLowerCase(primero)+yName.substring(1, yName.length());
        lblletters.setText(yName);
    } 
